...
<body>
    ...
    <!-- Botão de voltar -->
    <a href="/rango-main/resources/views/home.blade.php" class="btn-back">
    ...
    <div class="login-container">
        ...
        <form id="loginForm">
            ...
            <p class="error-message" id="errorMessage">
                <a href="/rango-main/resources/views/redefinirSenha.blade.php" style="text-decoration: none; color: #d4171d;">Esqueci minha senha</a>
            </p>
            <!-- Texto alternativo -->
            <p class="text-center" style="color: #ed1c24;">Não tem uma conta? <a href="/rango-main/resources/views/cadastroUsuario.blade.php" style="text-decoration: none; color: #d4171d;">Cadastre-se aqui</a></p>
        </form>
    </div>
