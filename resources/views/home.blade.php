    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #ed1c24; padding: 10px 30px;">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <!-- Aumentando a visibilidade dos links -->
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/rango-main/resources/views/login.blade.php" style="font-size: 18px; font-weight: bold;">Login ou Cadastro</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/rango-main/resources/views/contato.blade.php" style="font-size: 18px; font-weight: bold;">Contato</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/rango-main/resources/views/cardapio.blade.php" style="font-size: 18px; font-weight: bold;">Cardápio</a>
                    </li>
                    <!-- Atalho para a área restrita com ícone de cadeado -->
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/rango-main/resources/views/loginFuncionario.blade.php" style="font-size: 18px; font-weight: bold;">
                            <i class="bi bi-lock"></i> Área Restrita
                        </a>
                    </li>
                    <!-- Ícone do carrinho -->
                    <li class="nav-item">
                        <a class="nav-link text-white" href="/rango-main/resources/views/carrinho.blade.php" style="font-size: 18px; font-weight: bold;">
            ...
            <div class="row text-center text-md-start align-items-center">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    <ul style="list-style: none; padding-left: 0;">
                        <li><a href="/rango-main/resources/views/cardapio.blade.php" style="text-decoration: none; color: white;">Cardápio</a></li>
                        <li><a href="/rango-main/resources/views/contato.blade.php" style="text-decoration: none; color: white;">Contato</a></li>
                    </ul>
                </div>
