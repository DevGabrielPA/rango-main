...
<!-- Botão para voltar -->
<a href="/rango-main/resources/views/controleEstoque.blade.php" class="btn-back">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/rango-main/resources/views/controleEstoque.blade.php" method="post" enctype="multipart/form-data">
