...
<body>
    ...
    <div class="login-container">
        ...
        <!-- Formulário -->
        <form action="/rango-main/resources/views/login.blade.php" method="POST">
            @csrf
            <!-- Nome -->
            <div class="mb-3">
            ...
            <div class="d-grid mb-3">
                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('usuário cadastrado');">Cadastrar</button>
            </div>
            <!-- Texto alternativo -->
            <p class="text-center" style="color: #ed1c24;">Já tem uma conta? <a href="/rango-main/resources/views/login.blade.php" style="text-decoration: none; color: #d4171d;">Entre aqui</a></p>
        </form>
    </div>
