...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #ed1c24; padding: 10px 30px;">
        <a class="navbar-brand" href="/rango-main/resources/views/home.blade.php">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <!-- Home com ícone -->
                <li class="nav-item">
                    <a class="nav-link text-white" href="/rango-main/resources/views/home.blade.php" style="font-size: 18px; font-weight: bold;">
...
<div class="container mt-5">
    ...
    <div class="text-center mt-4">
        <a href="/rango-main/resources/views/carrinho.blade.php" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja finalizar esta compra?');">Finalizar Compra</a>
    </div>
</div>
