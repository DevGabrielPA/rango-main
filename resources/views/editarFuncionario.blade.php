...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <form action="/rango-main/resources/views/infoFuncionarios.blade.php" method="POST">
                <div class="mb-3">
                ...
                <a href="/rango-main/resources/views/infoFuncionarios.blade.php" class="btn btn-secondary">Cancelar</a>
            </form>
        </div>
    </div>
</div>
